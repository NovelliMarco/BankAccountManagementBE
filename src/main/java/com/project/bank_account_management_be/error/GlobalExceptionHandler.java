...
public class GlobalExceptionHandler {
    ...
    @ApiResponse(responseCode = "404", description = "Utente non trovato",
            content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
    public ResponseEntity<ErrorResponse> handleUtenteNotFoundException(UtenteNotFoundException ex) {
        ErrorResponse error = new ErrorResponse(
                LocalDateTime.now(),
                HttpStatus.NOT_FOUND.value(),
                "Not Found",
    ...
    @ApiResponse(responseCode = "404", description = "Password non corretta",
            content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
    public ResponseEntity<ErrorResponse> handleUtenteNotFoundException(PasswordValidationException ex) {
        ErrorResponse error = new ErrorResponse(
                LocalDateTime.now(),
                HttpStatus.NOT_FOUND.value(),
                "Not Found",
